...
export const ERR_USER_EMAIL_NOT_SPECIFIED = "The current user's email is not specified";
...
export const useRequestHistoryQuery = ({
  currentUser,
}: PropsWithCurrentUser): UseRequestHistoryResult => {
